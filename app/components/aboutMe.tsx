  ...
  return (
    <>
      ...
      <p className="my-10 text-xl px-[20rem] text-center">
        ...
        consequuntur modi mollitia! Ad deleniti vitae optio rerum voluptatem,
        nihil accusantium? Beatae at alias deleniti debitis. Aut consequuntur
        ratione laudantium dolor!
      </p>
        ...
        <div className=" flex justify-between mb-10">
          <div className="w-[45%]">
            ...
            <p className="text-justify">
              ...
              similique rem in, esse dolore, alias voluptatum veritatis officiis
              dolorem dolor quasi eligendi.
            </p>
          </div>
          <div className="w-[45%]">
